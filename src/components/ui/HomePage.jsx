...
const MapSection = () => {
    ...
    return (
        <section id="map" className="p-[200px] rounded-lg shadow-lg mt-6 dark:bg-gray-900">
            ...
            <div className="flex justify-center mb-8">
                <button
                    className="py-3 px-6 bg-green-600 text-white rounded-lg transition duration-300 shadow-lg hover:bg-green-700">
                    Partir
                </button>
            </div>
